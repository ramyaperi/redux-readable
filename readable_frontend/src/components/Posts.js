...
class Posts extends Component {
  ...
  editComment = (id) => {
    var text = this.props.comments.find(function(comment) {
    ...
    this.props.comments.find(function(comment) {
      if (comment.id === id) {
    ...
    return (<div className="posts">
      <Grid>
        ...
        <div >
          <Row>
            <h5>Comment</h5>
            <textarea id="commentsText" rows="4" cols="50" style={{
                border: 'solid 2px'
              }} value={this.state.newComment} name="newComment" onChange={this.handleChange}></textarea>
          </Row>
          <Row>
            <h5>Author</h5>
            <input id="commentsAuthor" style={{
                border: 'solid 2px'
              }} value={this.state.newAuthor} name="newAuthor" onChange={this.handleChange}></input>
